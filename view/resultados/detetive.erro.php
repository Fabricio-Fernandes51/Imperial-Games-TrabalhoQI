...
<body class="dr-ht-red-blue">
    ...
    <section class="wi-100 he-100">
        <fieldset>
            <div class="text-center">
            <h2>Infelizmente você errou, tente pensar um pouco mais</h2>
            <br>
            <a href="../jogos.detetive.php"><img class="wi-25 he-25 mg-bt-10 mg-top-5" src="../../img/imagens-quiz/erro.png" alt=""></a>
            </div>
        </fieldset>
    </section>
